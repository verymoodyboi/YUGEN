  ...
  return (
    <>
      ...
      <Section title="8. Copyright & DMCA Policy">
        <p>
          Yūgen Studios respects intellectual property rights and expects users
          to do the same.
        </p>

        <p>
          If you believe content on the platform infringes your copyright or
          copyrights of someone you know, you may submit a notice including:
        </p>
        ...
        <p>
          Notices may be sent to: <strong>support@try-yugen.com</strong>
        </p>

        <p>
          Repeat infringers may have their accounts terminated where required by
          law.
        </p>
      </Section>
