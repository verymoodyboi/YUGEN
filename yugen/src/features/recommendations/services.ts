import { api } from "../../lib/api"; // adjust path based on where you keep api.ts

export const fetchHotThisWeek = async (offset = 0, limit = 5) => {
...
export const fetchRecommended = async (user_id: string, offset = 0, limit = 5) => {
...
export const fetchFilmsByGenre = async (genre: string, offset = 0, limit = 5) => {
...
// fetch latest films for a profile (paginated)
