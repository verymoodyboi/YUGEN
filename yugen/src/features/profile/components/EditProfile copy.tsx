...
const EditProfile: React.FC<Props> = ({ onSubmitSuccess, onCancel }) => {
  ...
  return (
    <div className="h-[85vh] bg-emerald-50 text-emerald-950 overflow-y-scroll font-freckle p-6">
      <ToastContainer position="top-left" />

      <div className="max-w-3xl mx-auto bg-emerald-50 border-4 border-emerald-950 rounded-3xl p-6 shadow-xl">
