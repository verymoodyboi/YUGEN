...
const CommentSection = () => {
  ...
  return (
    <Stack spacing={2}  sx={{ mt: 4, width: "100%" }}>
      <Typography variant="h6" color="white" sx={{ fontFamily: '"Freckle Face", system-ui' }}>Comments</Typography>
      ...
      <List sx={{ backgroundColor: "rgba(255, 255, 255, 0.2)", borderRadius: "2%"}}>
        {comments.map((comment, index) => (
          <ListItem key={index} alignItems="flex-start">
            ...
            <ListItemText
              primary={
                <Typography sx={{ fontFamily: '"Freckle Face", system-ui', fontWeight: "bold" }}>
                    User
                </Typography>
              }
              secondary={
  ...
  return (
    <div>
      <div className="filmpage-wrapper">
        <Stack direction="column" spacing={2} sx={{ width: "100%", alignItems: "flex-start" }}>
          <Stack
            direction="row"
            spacing={1}
            alignItems="center"
          ...
          >
            ...
            <Typography variant="body1" sx={{ fontFamily: '"Freckle Face", system-ui' }}>
              username
            </Typography>
          ...
          <Stack className="filmpage-cover-and-filmname" direction="row" spacing={2} alignItems="center" width="100%">
            ...
            {/*Film Name*/}
            <Typography variant="h5" color="white" sx={{ fontFamily: '"Freckle Face", system-ui'}}>Film Title</Typography>
          </Stack>

          <Stack className="filmpage-genres-container" direction="row" spacing={1} flexWrap="wrap" alignItems="center">
          ...
          <Stack className="filmpage-review-container" direction="column" spacing={2} alignItems="flex-end" sx={{ width: "100%" }}>
            <Stack direction="row" spacing={2} alignItems="center">
                <StarIcon sx={{ color: "#ff7f27" }} />
                <Typography variant="h6" sx={{ fontFamily: '"Freckle Face", system-ui' }}>{V_Rating}</Typography>
                <Button
                  variant="contained"
                  startIcon={<AddIcon />}
          ...
          <div className="filmpage-appendices" style={{ width: "90%" }}>
            <Accordion
              ...
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography sx={{ fontFamily: '"Freckle Face", system-ui' }}>Description</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography sx={{ fontFamily: '"Freckle Face", system-ui' }}>{Description}</Typography>
              </AccordionDetails>
            ...
            <Accordion
              ...
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography sx={{ fontFamily: '"Freckle Face", system-ui' }}>Cast</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography sx={{ fontFamily: '"Freckle Face", system-ui' }}>{Cast}</Typography>
              </AccordionDetails>
            ...
            <Accordion
              ...
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography sx={{ fontFamily: '"Freckle Face", system-ui' }}>Crew</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography sx={{ fontFamily: '"Freckle Face", system-ui' }}>{Crew}</Typography>
              </AccordionDetails>
